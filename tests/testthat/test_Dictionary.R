...
test_that("typed construction", {
    ...
    # elements different types
    expect_error(Dictionary$new(list(a = 1, b = "b"), types = "numeric"), "character")
    expect_silent(Dictionary$new(list(a = 1, b = "b"), types = c("numeric", "character")))
    # custom types
    expect_silent(Dictionary$new(list(r = Reals$new(), b = Naturals$new()), types = "Set"))
})
...
test_that("add typed", {
    ...
    expect_equal(
      Dictionary$new(list(a = 1, b = 2), types = "numeric")$add(list(c = 3, d = 4)),
...
test_that("active", {
    ...
    expect_error({ d_typed$items$a = "c" })
